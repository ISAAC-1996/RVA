...
@media print 
  ...
  .bulle-discussion
    ...
    border: 2px solid #254680 !important
    font-family: 'Nunito', sans-serif  !important
    -webkit-print-color-adjust: exact !important
    print-color-adjust: exact !important
  .section-lancements
  ...
  .bulle-dis
    background-color: #fffacc!important   
    border: 3px solid #254680!important
    font-family: 'Nunito', sans-serif  !important
    -webkit-print-color-adjust: exact !important
    print-color-adjust: exact !important
  .footer
...
<div class="section-titles"><h2>Suivi des switchs</h2></div>
...
<div class="section-titles"><h2>Princeps non substitués</h2></div>
    ...
    <tbody>
      ...
      if (!is.null(params$top_5) && nrow(params$top_5) > 0) {
        for (i in 1:nrow(params$top_5)) {
          ...
          cat(paste0('<td style="text-align: right !important;">', params$top_5[i, "PFHT"], '€</td>'))
          cat('</tr>')  
        }
      } else {
...
<div class="discussion-wrapper">
  <div class="bulle-im"><img src="https://isaac-1996.github.io/RVA/im2.png" alt="Conseillère"/></div>
